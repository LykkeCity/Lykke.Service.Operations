...
namespace Lykke.Service.Operations.Client.AutorestClient.Models
{
    ...
    public partial class SwiftModel
    {
        /// <summary>
        ...
        /// Initializes a new instance of the SwiftFieldsModel class.
        /// </summary>
        public SwiftModel(string bic = default(string), string accNumber = default(string), string accName = default(string), string accHolderAddress = default(string), string bankName = default(string), string accHolderCountry = default(string), string accHolderZipCode = default(string), string accHolderCity = default(string))
        {
            Bic = bic;
            AccNumber = accNumber;
            AccName = accName;
